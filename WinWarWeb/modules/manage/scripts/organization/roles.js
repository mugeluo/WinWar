define(function (require, exports, module) {
    ...
    ObjectJS.bindEvent = function () {
        ...
        $("#updateObject").click(function () {
            var _this = $(this);
            Global.post("/Manage/Organization/GetRoleByID", { id: _this.data("id") }, function (data) {
    ...
    ObjectJS.createModel = function () {
        ...
        doT.exec("manage/template/organization/role-detail.html", function (template) {
            var html = template([]);
            Easydialog.open({
                container: {
    ...
    ObjectJS.getList = function () {
        ...
        Global.post("/Manage/Organization/GetRoles", {}, function (data) {
    ...
    ObjectJS.bindList = function (items) {
        ...
        if (items.length > 0) {
            doT.exec("manage/template/organization/roles.html", function (template) {
    ...
    ObjectJS.saveModel = function (model) {
        var _self = this;
        Global.post("/Manage/Organization/SaveRole", { entity: JSON.stringify(model) }, function (data) {
    ...
    ObjectJS.deleteModel = function (id, callback) {
        Global.post("/Manage/Organization/DeleteRole", { roleid: id }, function (data) {
    ...
    ObjectJS.bindPermissionEvent = function (roleid) {
        $("#savePermission").click(function () {
            ...
            Global.post("/Manage/Organization/SaveRolePermission", {
                roleid: roleid,
                permissions: menus
            }, function (data) {
                if (data.status) {
    ...
    ObjectJS.bindMenu = function (permissions, menus) {
        ...
        doT.exec("manage/template/organization/permissions.html", function (template) {
